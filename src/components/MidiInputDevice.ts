...
export class MidiInputDevice extends MidiLearnableComponent implements SupportsSelect {
  ...
  selectOptions: { id: string, name: string }[] = DEFAULT_SELECTIONS
  selectedId: string
  private deviceMap: { [id: string]: MIDIInput }
  ...
  protected override onMidiLearnConnection(input: MIDIInput): void {
